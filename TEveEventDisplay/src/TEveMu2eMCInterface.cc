    ...
    if(mcchitspcol == 0 && Redraw){
      ...
      if(mcchitspcol!=0){
        ...
        for(size_t i=0; i<mcchitspcol->size();i++){
          ...
          TEveMu2eCaloSimParticle *teve_particle2D = new TEveMu2eCaloSimParticle(simpartmc);
          TEveMu2eCaloSimParticle *teve_particle3D = new TEveMu2eCaloSimParticle(simpartmc);
